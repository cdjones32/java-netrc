...
public class NetrcParserTest {
    ...
    private void assertCredentials(TestHost host, Credentials cred)
    {
        if (cred == null) {
            ...
            assertEquals("Host." + host.name() + ": Login mismatch.", host.login, cred.user());
            assertEquals("Host." + host.name() + ": Password mismatch.", host.password, cred.password());
        }
    }
    ...
    {
        NetrcParser netrc = NetrcParser.getInstance(testFilePath_1);
        assertNotNull(netrc);
    }
    ...
    {
        NetrcParser netrc = NetrcParser.getInstance(new File(testFilePath_1));
        assertNotNull(netrc);
    }
    ...
    public void testGetCredentialsModifyFile() throws IOException
    {
        ...
        NetrcParser netrc = NetrcParser.getInstance(testFilePath);
        assertNotNull(netrc);
    ...
    public void testGetCredentialsOtherFile()
    {
        ...
        netrc = NetrcParser.getInstance(testFilePath_2);
        assertNotNull(netrc);
